...
gedGsfElectronsTmp = cms.EDProducer("GEDGsfElectronProducer",
    ...
    HoETowerPtCut = cms.double(25.0),
    maxFull5x5_sigmaIetaIetaTowerBarrel = cms.double(0.012),
    maxFull5x5_sigmaIetaIetaTowerEndcap = cms.double(0.045),
    maxDeltaEtaSeedClusterTrackAtVtxTowerBarrel = cms.double(0.01),
    maxDeltaEtaSeedClusterTrackAtVtxTowerEndcap = cms.double(0.009),
    towerPtSafetyThreshold = cms.double(200.0),
    ...
    HoEPflowTowerPtCut = cms.double(0.0),
    maxFull5x5_sigmaIetaIetaPflowTowerBarrel = cms.double(9999.),
    maxFull5x5_sigmaIetaIetaPflowTowerEndcap = cms.double(9999.),
    maxDeltaEtaSeedClusterTrackAtVtxPflowTowerBarrel = cms.double(9999.),
    maxDeltaEtaSeedClusterTrackAtVtxPflowTowerEndcap = cms.double(9999.),
    towerPtSafetyThresholdPflow = cms.double(0.0),
