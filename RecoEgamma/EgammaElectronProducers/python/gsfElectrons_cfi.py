...
ecalDrivenGsfElectrons = cms.EDProducer("GsfElectronEcalDrivenProducer",
    ...
    maxFull5x5_sigmaIetaIetaPflowTowerBarrel = cms.double(0.0),
    maxFull5x5_sigmaIetaIetaPflowTowerEndcap = cms.double(0.0),
    maxDeltaEtaSeedClusterTrackAtVtxPflowTowerBarrel = cms.double(0.0),
    maxDeltaEtaSeedClusterTrackAtVtxPflowTowerEndcap = cms.double(0.0),
